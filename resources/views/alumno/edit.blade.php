...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <form action="/alumnos/{{ $alumno->id }}" method="post" class="col-md-12">
                @csrf
                @method('PUT')
                <div class="form-group col-md-4 col-xs-12">
                    <label for="name">Nombre(s)</label>
                    <input type="text" id="nombre" name="nombre" value="{{ $alumno->nombre }}" class="form-control">
                </div>
                <div class="form-group col-md-4 col-xs-12">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="fechaNacimiento" value="{{ $alumno->fechaNacimiento }}"
                                class="form-control datepicker" name="fechaNacimiento">
                ...
                <div class="form-group col-md-4 col-md-offset-2 col-xs-12"><label for="estadoCivil">Estado Civil</label>
                    <select id="estadoCivil" name="estadoCivil" value="{{ $alumno->estadoCivil }}" class="form-control">
                ...
                <div class="form-group col-md-12 col-xs-12"><label for="name">Domicilio. Calle y número</label> <input
                        type="text" id="domicilio" name="domicilio" value="{{ $alumno->domicilio }}"
                        class="form-control">
                </div>
                <div class="form-group col-md-4 col-xs-12"><label for="name">Colonia</label> <input type="text" id="colonia"
                        name="colonia" value="{{ $alumno->colonia }}" class="form-control"></div>
                ...
                <div class="form-group col-md-4 col-xs-12"><label for="cp">CP</label> <input type="text" id="cp" name="cp"
                        value="{{ $alumno->cp }}" class="form-control"></div>
                ...
                <div class="form-group  col-md-4 col-xs-12"><label for="municipio">Municipio</label> <select id="municipio"
                        name="municipio" value="{{ $alumno->municipio }}" class="form-control">
                ...
                <div class="form-group col-md-4 col-xs-12"><label for="contacto">Contacto en Caso de Emergencia</label>
                    <input type="text" id="contacto" name="contacto" value="{{ $alumno->contacto }}"
                        class="form-control">
                </div>
                <div class="form-group col-md-4 col-xs-12"><label for="jubilado">¿Es Jubilado?</label> <select id="jubilado"
                        name="jubilado" value="{{ $alumno->jubilado }}" class="form-control">
                        <option>Si</option>
                        <option>No</option>
                    </select></div>
                <div class="form-group col-md-4 col-xs-12"><label for="institucionJubilacion">Institución de
                        ...
                        value="{{ $alumno->institucionJubilacion }}" class="form-control"></div>
                <div class="form-group col-md-4 col-xs-12"><label for="equipo">Con que equipo de cómputo cuenta</label>
                    <select id="equipo" name="equipo" value="{{ $alumno->equipo }}" class="form-control">
                ...
                <div class="form-group col-md-4 col-xs-12"><label for="internet">Cuenta con Internet</label> <select
                        id="internet" name="internet" value="{{ $alumno->internet }}" class="form-control">
                        <option>No</option>
                        <option>Si</option>
